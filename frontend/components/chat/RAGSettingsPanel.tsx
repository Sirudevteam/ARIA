...
export function RAGSettingsPanel({
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-[200px] text-xs bg-slate-900 text-white border-slate-800">
              <p>{tooltip}</p>
            </TooltipContent>
          </Tooltip>
        </div>
        <span className="text-xs font-mono text-blue-700 bg-blue-50 border border-blue-200 px-1.5 py-0.5 rounded font-bold">
          {format(value)}
        </span>
      </div>
      <Slider
  ...
  return (
    <div className="p-5 bg-white rounded-xl border border-slate-200 space-y-6 shadow-xs">
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        ...
        <Button
          ...
          className="h-7 text-[10px] text-slate-500 hover:text-slate-800 hover:bg-slate-100 font-medium"
        >
